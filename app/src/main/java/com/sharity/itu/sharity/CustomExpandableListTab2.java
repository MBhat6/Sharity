...
public class CustomExpandableListTab2 extends BaseExpandableListAdapter implements OnClickListener{
    ...
    public CustomExpandableListTab2(Context context, ArrayList expandableList, String name) {
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        //listTitleTextView.setTextColor(Color.parseColor("#ffbb33"));
