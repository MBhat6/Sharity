...
public class CustomExpandableListTab3 extends BaseExpandableListAdapter implements OnClickListener{
    ...
    public CustomExpandableListTab3(Context context, ArrayList expandableList, String name) {
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        //listTitleTextView.setTextColor(Color.parseColor("#99cc00"));
